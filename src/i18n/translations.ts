...
export const translations = {
  es: {
    ...
    home: {
      heroTitle: 'Bienvenido a Iglesia Bíblica Gracia Cajamarca',
      heroSubtitle:
        'Una comunidad que ama a Dios, estudia su Palabra y sirve a su prójimo.',
  ...
  en: {
    ...
    home: {
      heroTitle: 'Welcome to Iglesia Bíblica Gracia Cajamarca',
      heroSubtitle:
        'A community that loves God, studies His Word, and serves its neighbors.',
