...
export const translations = {
  es: {
    ...
    events: {
      ...
      subtitle: 'Nuestras reuniones semanales, siempre a la misma hora. ¡Te esperamos!',
      empty: 'Aún no hay un horario publicado. Vuelve pronto.',
      mainService: 'Reunión Principal',
    ...
    giving: {
      eyebrow: 'Mayordomía',
      title: 'Ofrendas',
      subtitle: 'Puedes dar tu ofrenda por Yape o transferencia bancaria.',
      verseQuote:
        'Cada uno debe dar según lo que haya decidido en su corazón, no de mala gana ni por obligación, porque Dios ama al que da con alegría.',
      verseRef: '— 2 Corintios 9:7',
      yapeTitle: 'Yape',
      yapeDesc: 'Escanea el código QR con tu app de Yape, o envía tu ofrenda directamente al número de la iglesia.',
      yapePhoneLabel: 'Número Yape',
      scanQr: 'Escanea el código QR',
      bankTransferTitle: 'Transferencia Bancaria',
      bankTransferDesc: 'También puedes hacer una transferencia directa a cualquiera de estas cuentas del BCP.',
      solesAccountTitle: 'Cuenta BCP (Soles)',
      dollarsAccountTitle: 'Cuenta BCP (Dólares)',
      accountNumberLabel: 'Número de cuenta',
      interbankNumberLabel: 'Cuenta interbancaria (CCI)',
    },
    footer: {
  ...
  en: {
    ...
    events: {
      title: 'Service Times',
      subtitle: 'Our weekly gatherings, always at the same time. We hope to see you there!',
      empty: 'No schedule has been published yet. Check back soon.',
      mainService: 'Main Gathering',
    ...
    giving: {
      eyebrow: 'Stewardship',
      title: 'Giving',
      subtitle: 'You can give by Yape or bank transfer.',
      verseQuote:
        'Each of you should give what you have decided in your heart to give, not reluctantly or under compulsion, for God loves a cheerful giver.',
      verseRef: '— 2 Corinthians 9:7',
      yapeTitle: 'Yape',
      yapeDesc: 'Scan the QR code with your Yape app, or send your gift directly to the church’s number.',
      yapePhoneLabel: 'Yape Number',
      scanQr: 'Scan the QR code',
      bankTransferTitle: 'Bank Transfer',
      bankTransferDesc: 'You can also transfer directly to either of these BCP accounts.',
      solesAccountTitle: 'BCP Account (Soles)',
      dollarsAccountTitle: 'BCP Account (Dollars)',
      accountNumberLabel: 'Account number',
      interbankNumberLabel: 'Interbank account (CCI)',
    },
    footer: {
